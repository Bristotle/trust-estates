...
export function WhatsAppFab() {
  return (
    <motion.a
      ...
      className="fixed bottom-5 right-5 z-40 group flex items-center gap-2 rounded-full bg-[#25D366] p-3.5 text-white shadow-[0_12px_40px_-8px_rgba(37,211,102,0.7)] hover:bg-[#1ebe5b] transition sm:py-3 sm:pl-3 sm:pr-4"
