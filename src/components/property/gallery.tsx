    ...
    <div>
      ...
      {images.length > 1 && (
        <div className="mt-3 grid grid-cols-4 gap-3">
          {images.map((src, k) => (
            <button key={src} onClick={() => setI(k)} className={cn("relative aspect-[4/3] overflow-hidden rounded-xl ring-2 ring-offset-2 ring-offset-cream-100 transition", k === i ? "ring-gold-500" : "ring-transparent opacity-70 hover:opacity-100")}>
