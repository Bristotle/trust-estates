...
export const properties: Property[] = [
  {
    ...
    highlights: ["Registered land title with Lands Commission", "Gated estate with 24/7 security", "Electricity and water at plot boundary", "Flexible 6 to 12 month payment plans"],
  ...
  },
  {
    ...
    summary: "Ocean-facing acreage beside the new Accra to Aflao highway. Ideal for resort or estate development.",
    description:
    ...
    highlights: ["Direct beach frontage", "Adjacent to Accra to Aflao dual carriageway", "Clean chain of title, no encumbrances", "Bulk pricing for 5+ acres"],
  ...
  },
  {
    ...
    description:
      "Turn-key rental investment: eight two-bedroom apartments, all occupied under annual leases, with on-site management already in place. Buyers receive audited rent roll and tenancy agreements. Strong capital appreciation in the Ahodwo to Nhyiaeso corridor.",
    highlights: ["Gross yield 14 to 18% per annum", "All 8 units currently let", "Professional property management included", "Audited rent roll available on request"],
  ...
  },
  {
    ...
    summary: "Corner plots on the Kwabenya to Atomic main road, zoned for commercial or residential use.",
    description:
